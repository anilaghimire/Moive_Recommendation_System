...
const Footer = () => {
  return (
    <footer className='bg-zinc-800 text-[#BB86FC] text-sm tracking-tighter flex justify-center items-center flex-col p-2 md:py-4 md:text-base'>
        ...
        <div>
            Made by <a href="https://github.com/ChiefBibek" target='_blank' className='hover:underline'>Anila</a> and <a href="https://github.com/AnwitDahal" target='_blank' className='hover:underline'>Ghimire</a>
        </div>
    </footer>
  )
}
