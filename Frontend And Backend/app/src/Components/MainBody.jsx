  ...
  return (
    <div className="my-7 ">
      ...
      {!showPopup && Array.isArray(movieres) && (
        <>
          <hr />
          <div className="mt-2 px-1 md:px-20">
            <h1 className="text-[#FF0000] font-semibold sm:text-lg md:text-xl lg:text-2xl font-list_title text-center mb-5 md:text-start">
